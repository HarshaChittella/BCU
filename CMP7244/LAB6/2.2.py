...
def main():
    cmp7244 = Module('Software Development', '20', 'CEBE')
    cmp7243 = Module('Software Snalysis', '20', 'CEBE')
    cmp7245 = Module('Database', '20', 'CEBE')
    Sid_1 = Student('Harsha', '1')
    Sid_1.enrol(cmp7243)
    Sid_1.enrol(cmp7245)
    Sid_1.print_student_info()
